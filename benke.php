...
$num=8;
$sql2="select * from article where tkind = 4";
    ...
    <div id="dao">
        <div class="dao1">
            ...
            <ul class="nav nav-stacked">
                <li ><a href="benke.php"  class="activea">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;本科教育</a></li>
                <li ><a href="yanjiu.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;研究生教育</a></li>
                <li><a href="jixu.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;继续教育</a></li>
            </ul>
        </div>
    </div>
    ...
    <div id="mainnewscontainer">
        ...
        <div id="news">
            <div id="list">
                <ul>
                    <?php
                    $sql1="select * from article where tkind = 4  AND tpub='1' AND tstatus='1'  limit $offset,$num;";
                    ...
                    if($total==0){
                        ...
                        while ($row = mysql_fetch_array($info)) {
                            ...
                            <li><span class="glyphicon glyphicon-chevron-right"></span> <a
                                    href="<?php echo "pcommon.php?id=" . $id ?>"><?php echo $row["title"]; ?></a><span
