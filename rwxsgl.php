...
$num=8;
$sql2="select * from article where tkind = 7";
    ...
    <div id="dao">
        <div class="dao1">
            ...
            <ul class="nav nav-stacked">
                ...
                <li ><a href="rwxsgl.php"  class="activea">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;学生管理</a></li>
    ...
    <div id="mainnewscontainer">
        ...
        <div id="news">
            <div id="list">
                <ul>
                    <?php
                    $sql1="select * from article where tkind = 7  AND tpub='1' AND tstatus='1'  limit $offset,$num;";
        ...
        <div id="page">
            <ul class="pagination">
                <?php
                $last=($page==1)?"<li><a href='#'>&laquo;</a></li>":"<li><a href='rwxsgl.php?page=".($page-1)."'>&laquo;</a></li>";
                $next=($page==$pagenum)?"<li><a href='#'>&raquo;</a></li>":"<li><a href='rwxsgl.php?page=".($page+1)."'>&raquo;</a></li>";
                echo $last;
                for($i=1;$i<=$pagenum;$i++){
                    $show=($i!=$page)?"<li><a href='rwxsgl.php?page=".$i."'>$i</a></li>":"<li><a href='#'><b> $i</b></a></li>";
                    echo $show;
                }
                echo $next;
                ?>`
