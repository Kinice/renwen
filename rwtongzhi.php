...
$num=8;
$sql2="select * from article where tkind = 3";
        ...
        <div class="dao1">
            ...
            <ul class="nav nav-stacked">
                <ul class="nav nav-stacked">
                    ...
                    <li><a href="rwtongzhi.php" class="activea">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;通知公告</a></li>
                </ul>
            </ul>
        </div>
    </div>
    ...
    <div id="mainnewscontainer">
        ...
        <div id="news">
            <div id="list">
                <ul>
                    <?php
                    $sql1="select * from article where tkind = 3  AND tpub='1' AND tstatus='1'  limit $offset,$num;";
