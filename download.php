...
<div id="mainbody">
    <div id="dao">
        <div class="dao1">
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-book"></span>&nbsp;规章制度</p>
            <ul class="nav nav-stacked">
                <li ><a href="download.php"  class="activea">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;文件下载</a></li>
            </ul>
        </div>
        </div>
    <!--MainNewsContainer-->
    <div id="mainnewscontainer">
        ...
        <div id="news">
            <div id="list">
                <ul>
                    <?php
                    $sql1="select * from document limit $offset,$num;";
                    ...
                    if($total==0){
                        ...
                        while ($row = mysql_fetch_array($info)) {
                            $id = $row["id"];
                            $time = substr($row["doctime"], 0, 10);
                            ?>
                            <li><span class="glyphicon glyphicon-chevron-right"></span> <a
                                    href="<?php echo "ytu/admin/uploadDoc/".$row['docpath']?>"><?php echo $row["docname"]; ?></a><span
