...
$num=8;
$sql2="select * from article where tkind = 6";
...
<div id="mainbody">
    <div id="dao">
        <div class="dao1">
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-book"></span>&nbsp;学科建设</p>
            <ul class="nav nav-stacked">
                <li ><a href="rwzhongdian.php" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;重点学科</a></li>
                <li ><a href="rwxueshu.php" class="activea">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;学术研究</a></li>
    ...
    <div id="mainnewscontainer">
        ...
        <div id="news">
            <div id="list">
                <ul>
                    <?php
                    $sql1="select * from article where tkind = 6  AND tpub='1' AND tstatus='1'  limit $offset,$num;";
                    ...
                    if($total==0){
                        ...
                        while ($row = mysql_fetch_array($info)) {
                            ...
                            <li><span class="glyphicon glyphicon-chevron-right"></span> <a
                                    href="<?php echo "common.php?id=" . $id ?>"><?php echo $row["title"]; ?></a><span
        ...
        <div id="page">
            <ul class="pagination">
                <?php
                $last=($page==1)?"<li><a href='#'>&laquo;</a></li>":"<li><a href='rwxueshu.php?page=".($page-1)."'>&laquo;</a></li>";
                $next=($page==$pagenum)?"<li><a href='#'>&raquo;</a></li>":"<li><a href='rwxueshu.php?page=".($page+1)."'>&raquo;</a></li>";
                echo $last;
                for($i=1;$i<=$pagenum;$i++){
                    $show=($i!=$page)?"<li><a href='rwxueshu.php?page=".$i."'>$i</a></li>":"<li><a href='#'><b> $i</b></a></li>";
                    echo $show;
                }
                echo $next;
                ?>`
