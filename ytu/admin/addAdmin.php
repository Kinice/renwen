	...
	<tr>
		...
		<td>
			<select name="adminKind">
				...
				<option value="2" selected="selected">图片新闻管理员</option>
				<option value="9">学院要闻管理员</option>
				<option value="3">通知公告管理员</option>
				<option value="3">师资队伍管理员</option>
				<option value="7">本科教育管理员</option>
				<option value="8">研究生教育管理员</option>
				<option value="4">继续教育管理员</option>
