...
<table width="75%" border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
	<tr>
		<td align="right" width="21%">姓名</td>
		<td><input type="text" name="teaname" placeholder="请输入教师姓名"/></td>
	</tr>
	
	<tr>
		<td align="right" width="21%">教师</td>
		<td>
			<select name="teakind">
	...
	<tr>
		<td align="right">导师研究方向</td>
		<td><input type="text" name="shuoshi" placeholder="多专业请以英文逗号分开！"/></td>
	</tr>
	<tr>
