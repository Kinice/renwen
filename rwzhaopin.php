...
<div id="mainbody">
    <div id="dao">
        <div class="dao1">
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-book"></span>&nbsp;人才培养</p>
            <ul class="nav nav-stacked">
                <li ><a href="benke.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;本科教育</a></li>
                <li ><a href="yanjiu.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;研究生教育</a></li>
                <li><a href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;继续教育</a></li>
                <li><a href="rwzhaopin.php" class="activea">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;招聘就业</a></li>
            </ul>
        </div>
    </div>
    ...
    <div id="mainnewscontainer">
        ...
        <div id="news">
            <div id="list">
                <ul>
                    <?php
                    $sql1="select * from article where tkind = 8  AND tpub='1' AND tstatus='1'  limit $offset,$num;";
        ...
        <div id="page">
            <ul class="pagination">
                <?php
                $last=($page==1)?"<li><a href='#'>&laquo;</a></li>":"<li><a href='rwzhaopin.php?page=".($page-1)."'>&laquo;</a></li>";
                $next=($page==$pagenum)?"<li><a href='#'>&raquo;</a></li>":"<li><a href='rwzhaopin.php?page=".($page+1)."'>&raquo;</a></li>";
                echo $last;
                for($i=1;$i<=$pagenum;$i++){
                    $show=($i!=$page)?"<li><a href='rwzhaopin.php?page=".$i."'>$i</a></li>":"<li><a href='#'><b> $i</b></a></li>";
                    echo $show;
                }
                echo $next;
                ?>`
