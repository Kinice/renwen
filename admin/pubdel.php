...
//只能查看自己未发布的文章 
$where = ' WHERE tstatus=2 AND aid='.($_SESSION['adminId']);
                        ...
                        <tbody>                
                            ...
                            <tr>
                                ...
                                <td align="center">
                                				...
                                				<input onclick="pubArticle(<?php echo $row['id'];?>)" type="button" value="发布" class="btn">
...
<script type="text/javascript">
	...
	function pubArticle(id){
		window.location="doAdminAction.php?act=pubArticle2&id="+id;	
	}

	function delArticle(id){
			if(window.confirm("您确定要删除吗？删除之后不可以恢复哦！！！")){
				window.location="doAdminAction.php?act=delArticle2&id="+id;
			}
	}
</script>
</html>
