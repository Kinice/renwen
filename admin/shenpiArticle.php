...
if (isset($_REQUEST['page']))
	...
	$page = 1;
$sql="select * from article where tpub=2 and tstatus=1";
...
$sql = "select * from article where tpub=2 and tstatus=1 limit {$offset},{$pageSize}";
$rows = fetchAll($sql);
?>
<!doctype html>
<html>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                				...
                                				<input onclick="passArticle(<?php echo $row['id'];?>)" type="button" value="审批通过" class="btn"  >
                                				<input onclick="ReArticle(<?php echo $row['id'];?>)" type="button" value="审批拒绝" class="btn">
...
<script type="text/javascript">
	function passArticle(id){
			window.location="doAdminAction.php?act=passArticle&id="+id;
	}
	function ReArticle(id){
			window.location="doAdminAction.php?act=ReArticle&id="+id;
	}
</script>
</html>
