...
if (isset($_REQUEST['page']))
	...
	$page = 1;
$sql="select * from article where tstatus=1";
...
$sql = "select * from article where tstatus=1 limit {$offset},{$pageSize}";
$rows = fetchAll($sql);
?>
<!doctype html>
<html>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                				...
                                				<?php 
                                					if ($row['thot'] == 0) {
                                				?>
                                				<input onclick="hotArticle(<?php echo $row['id'];?>)" type="button" value="加红" class="btn"  >
                                				<?php
													} else if ($row['thot'] == 1) {
														
                                				?>
                                				<input onclick="nothotArticle(<?php echo $row['id'];?>)" type="button" value="取消加红" class="btn">
					                            <?php
													}
					                            ?>
...
<script type="text/javascript">
	...
	function hotArticle(id){
		window.location="doAdminAction.php?act=hotArticle&id="+id;
	}
	function nothotArticle(id){
			window.location="doAdminAction.php?act=nothotArticle&id="+id;
	}
